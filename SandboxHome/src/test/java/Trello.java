...
public class Trello {
    ...
    public void Trello() {
        ...
        wd.findElement(By.id("name")).sendKeys("Ivan Petrov");
        wd.findElement(By.id("email")).click();
        wd.findElement(By.id("email")).clear();
        wd.findElement(By.id("email")).sendKeys("risuhin1990+2@gmail.com");
        wd.findElement(By.id("password")).click();
        wd.findElement(By.id("password")).clear();
        wd.findElement(By.id("password")).sendKeys("mastakdm1990");
